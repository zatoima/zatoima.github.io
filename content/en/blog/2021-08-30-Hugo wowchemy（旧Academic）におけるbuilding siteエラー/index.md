...
title: "Building Site Error in Hugo Wowchemy (formerly Academic)"
subtitle: ""
summary: " "
tags: ["Hugo"]
categories: ["Hugo"]
...
When trying to use Hugo Wowchemy and running a build, the following error occurred.
...
There was an official documentation article stating that the Extended version of Hugo is required.
...
Download the binary for the version you want to use (`hugo_extended_x.xx.x_xxxx`) from the link below, replace the existing Hugo binary, and rebuild.
