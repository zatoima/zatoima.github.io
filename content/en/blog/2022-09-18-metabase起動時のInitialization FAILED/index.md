...
title: "Handling Initialization FAILED Error on Metabase Startup"
subtitle: ""
summary: " "
tags: ["metabase"]
categories: ["metabase"]
...
Set environment variables to use the locally built PostgreSQL instead of the H2 database.
