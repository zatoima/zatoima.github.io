...
title: "Installing PostgreSQL on M1 Mac"
subtitle: ""
summary: " "
tags: ["PostgreSQL"]
...
On Linux, pgbench requires installing `postgresql-contrib`, but with Homebrew it appears to be installed together.
...
Trying to connect to AWS RDS and run pgbench (data generation only).
