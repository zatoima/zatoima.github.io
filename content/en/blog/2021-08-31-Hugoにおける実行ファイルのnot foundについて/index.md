...
title: "About the Executable Not Found Error in Hugo"
subtitle: ""
summary: " "
tags: ["Hugo"]
categories: ["Hugo"]
...
An error occurs indicating that the Go executable file cannot be found in the PATH environment variable.
...
The [official documentation](https://wowchemy.com/docs/guide/troubleshooting/#error-go-executable-not-found) has information about this.
...
On Windows, running the PowerShell commands described in [this official documentation](https://wowchemy.com/docs/getting-started/install-hugo-extended/) resolved the error.
