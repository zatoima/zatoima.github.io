...
title: "Conversion Results from Oracle to PostgreSQL Using ora2pg"
subtitle: ""
summary: " "
...
I tried converting from Oracle to Aurora (PostgreSQL) using ora2pg, the same conversion I previously performed with AWS SCT.

> Conversion Results from Oracle to Aurora (PostgreSQL) Using AWS Schema Conversion Tool | my opinion is my own https://zatoima.github.io/aws-sct-oracle-to-aurora-postgresql-conversion.html
...
The comparison results between Oracle and PostgreSQL are as follows. Some results differed between SCT and ora2pg. For SCT, refer to:

> Conversion Results from Oracle to Aurora (PostgreSQL) Using AWS Schema Conversion Tool | my opinion is my own https://zatoima.github.io/aws-sct-oracle-to-aurora-postgresql-conversion.html

### Oracle vs PostgreSQL Comparison

| No.  | Oracle (desc result)          | PostgreSQL (\d metacommand result) |
| ---- | ----------------------------- | ---------------------------------- |
