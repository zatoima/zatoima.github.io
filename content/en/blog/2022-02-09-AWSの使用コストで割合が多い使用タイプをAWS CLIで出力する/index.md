...
title: "Output the Usage Types with the Highest Proportion of AWS Costs Using the AWS CLI"
subtitle: ""
summary: " "
tags: ["AWS"]
categories: ["AWS"]
...
You can check the breakdown by selecting `Usage Type` as the group-by condition in Cost Explorer.

![image-20220130210536361](image-20220130210536361.png)

If you want to check quickly, run the following via AWS CLI:
