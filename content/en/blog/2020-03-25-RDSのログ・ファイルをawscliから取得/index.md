...
title: "Getting and Checking RDS/Aurora Log Files with AWS CLI"
subtitle: ""
summary: " "
...
This is intended for use when checking from the CLI is more convenient than using the Management Console.
...
Whether it is the latest file can be verified from `LastWritten`.
