...
title: "Checking MySQL Binary Logs"
subtitle: ""
summary: " "
tags: ["MySQL"]
categories: ["MySQL"]
...
-- Check existing binary logs and switch binary log
show binary logs;
flush binary logs;
show binary logs;

-- Check binary log
-- At this point, the binary log contains no update information
...
use mydb;
desc t1;
insert into t1 values(1,'First Insert','test data',5555,now());

-- Check binary log
-- The above Insert is recorded
show binlog events in 'awsstg-db001-bin.000011';

-- Execute after changing binlog_format
show variables like 'binlog_format';
set session binlog_format='STATEMENT';
show variables like 'binlog_format';

insert into t1 values(2,'Second Insert','test data',5555,now());
...
mysql>
mysql> insert into t1 values(1,'First Insert','test data',5555,now());
...
mysql> insert into t1 values(2,'Second Insert','test data',5555,now());
Query OK, 1 row affected (0.00 sec)
...
| awsstg-db001-bin.000011 | 656 | Query          |         1 |         808 | use `mydb`; insert into t1 values(2,'Second Insert','test data',5555,now())       |
