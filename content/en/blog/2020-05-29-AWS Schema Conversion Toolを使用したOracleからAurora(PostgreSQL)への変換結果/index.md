...
title: "Conversion Results from Oracle to Aurora (PostgreSQL) Using AWS Schema Conversion Tool"
subtitle: ""
summary: " "
...
Checking how the AWS Schema Conversion Tool performs conversions. The DDL definitions were borrowed from the AWS Database Migration Playbook. The target was Aurora (PostgreSQL), but the results would be the same for RDS (PostgreSQL).
...
The comparison results between Oracle and PostgreSQL are as follows.

### Oracle vs PostgreSQL Data Type Comparison
