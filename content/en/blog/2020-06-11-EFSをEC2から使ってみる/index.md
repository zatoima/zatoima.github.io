...
title: "Mounting and Using EFS from EC2"
subtitle: ""
summary: " "
tags: ["AWS","EC2","EFS"]
...
Assuming EFS has already been created in the Management Console...
...
Specify the filesystem ID as `fs-xxxxx`.

![image-20200502143317622](image-20200502143317622.png)

Verify with df that EFS is mounted:
...
### Quick Performance Test (dd Command)
