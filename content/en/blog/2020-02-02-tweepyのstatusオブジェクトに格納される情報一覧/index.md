...
title: "List of Information Stored in Tweepy's Status Object"
subtitle: ""
summary: " "
...
I've been automating things with the Twitter API and Python. Since it's tedious to Google every time or output the contents of tweepy's status object to check, I'm writing this as a reference note.

### Prerequisites

You need to have applied for Twitter API access and obtained the following keys and tokens:
...
> Reference: Twitter API Registration (Account Application Process) and Steps Until Approval - Summary as of August 2019 - Qiita https://qiita.com/kngsym2018/items/2524d21455aac111cdee
...
| status.user.friends_count    | Number of accounts following            |
| status.user.followers_count  | Number of followers                     |
| status.user.description      | Bio                                     |

There are many other fields as well, so here is the full output:
