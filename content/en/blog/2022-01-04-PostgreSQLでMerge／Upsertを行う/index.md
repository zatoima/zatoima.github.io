...
title: "Performing Merge/Upsert in PostgreSQL"
subtitle: ""
summary: " "
tags: ["PostgreSQL"]
...
PostgreSQL does not have a MERGE statement; instead, you use INSERT ON CONFLICT. In the past, UPSERT was performed using CTEs (Common Table Expressions). The main thing to note is that a constraint is required for the ON CONFLICT clause.
