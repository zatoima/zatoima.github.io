...
東京リージョンのIO料金については`0.24USD/100 万リクエスト`となる。また、各データページで最大 4KB の変更に対して 1 回の I/O オペレーションを課金される。仮に秒間2000IOPS発生するワークロードあった場合の月額費用は下記で計算される。（なお、秒間2,000IOPSというワークロードは非常に高いのであくまでも目安として。）
